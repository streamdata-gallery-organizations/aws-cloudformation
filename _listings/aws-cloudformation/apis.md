...
- name: AWS CloudFormation API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-cloudformation/master/_listings/aws-cloudformation/action-validatetemplate-get.md
x-common:
